...
func launchTemporaryRemoteDebugBrowser(_ context.Context, _ Options) (string, *remoteDebugBrowserInfo, func(), func(), error) {
	return "", nil, nil, nil, fmt.Errorf("temporary remote-debug browser login is currently supported on macOS only")
}
